...
\bibitem{hun} Hunt Allcott and Matthew Gentzkow. 2017.\@
``Social media and fake news in the 2016 election''
Journal of Economic Perspectives 31, 2 (2017), 211–36.

\bibitem{fuk} 福島隆寛, and 内海彰.\@
``Web ページの信頼性の自動推定''\@ 知能と情報 19.3 (2007): 239-249.

\bibitem{gra} Mykhailo Granik and Volodymyr Mesyura. \@
...
\bibitem{wu} Wu, Liang, and Huan Liu.\@
...
\bibitem{rub} Rubin, Victoria, et al.\@
...
\bibitem{hor} Horne, Benjamin D., and Sibel Adali.\@
``This just in: fake news packs a lot in title, uses simpler, repetitive content in text body, more similar to satire than real news.''
arXiv preprint arXiv:1703.09398 (2017).

\bibitem{jin} Jin, Zhiwei, et al.\@
...
\bibitem{eann} Wang, Yaqing, et al.\@
